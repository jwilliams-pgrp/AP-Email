...
def _prompt(
    ...
    return (
        ...
        "When visible source text matches a listed asset, populate canonical normalized lookup candidates such as property_lookup.property_name=[\"alliance gateway 34\"] and property_lookup.property_code=[\"gw34\"]. "
        "Labeled identity fields such as Project, Job, Site, Location, Service Location, Property, Building, Ship To, Deliver To, and similar labels are source-visible property identity evidence. "
        "When the value following one of these labels visibly matches an asset_reference asset_name or asset_alias, populate property_lookup.property_name with the normalized asset name and property_lookup.property_code with the normalized asset_alias when available. "
        ...
        "Treat labels such as Building, Property, Site, Job, Location, Ship To, Deliver To, Service Location, and the email subject as property identity sources. "
        "Before returning JSON, scan selected attachment text for labels Project, Job, Site, Location, Service Location, Property, Building, Ship To, and Deliver To; if the labeled value visibly matches an asset_reference asset_name or asset_alias, ensure property_lookup.property_name or property_lookup.property_code includes that normalized candidate. "
