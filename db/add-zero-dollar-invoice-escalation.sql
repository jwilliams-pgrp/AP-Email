-- Adds dedicated escalation routing for zero-dollar invoices that would otherwise auto-route.
...
values
  (
    'amount_zero_invoice',
    'Zero-dollar invoice requires escalation',
    360,
    true,
    'amount_equals_zero',
    'ESCALATE',
    'ESCALATE_0_DOLLAR_INVOICE',
    'Invoice amount is zero and normal destination would auto-route -> ESCALATE with 0-DOLLAR-INVOICE label',
    '2026-06-15',
    1
  )
...
where wr.rule_code = 'amount_zero_invoice'
